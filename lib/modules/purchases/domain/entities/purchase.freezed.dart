...
class _$PurchaseImpl implements _Purchase {
  ...
  @override
  String toString() {
    return 'Purchase(id: $id, invoiceNumber: $invoiceNumber, supplierId: $supplierId, purchaseDate: $purchaseDate, warehouseId: $warehouseId, totalAmount: $totalAmount, discountPercent: $discountPercent, discountAmount: $discountAmount, taxPercent: $taxPercent, taxAmount: $taxAmount, grandTotal: $grandTotal, paidAmount: $paidAmount, dueAmount: $dueAmount, status: $status, paymentStatus: $paymentStatus, note: $note, businessId: $businessId, createdBy: $createdBy, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Purchase implements Purchase {
  const factory _Purchase(
      ...
      final int? createdBy,
      final DateTime? createdAt,
      final DateTime? updatedAt}) = _$PurchaseImpl;
